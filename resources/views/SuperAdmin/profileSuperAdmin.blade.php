            ...
            <div class="card-body">
                <form action="{{ route('EditProfile') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="username" id="username" type="text" placeholder="" value="{{ auth()->user()->username }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="name"><b>Nama</b></label>
                        <input class="form-control" name="name" id="name" type="text" placeholder="" value="{{ auth()->user()->name }}" required>
                    </div>
                    <div class="mb-3">
