				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">@yield('page_name')</h2>
                            </div>
                        </div>
                    </div>
				</div>
			...
			<footer class="footer">
				<div class="container-fluid">
                    <div class="copyright ml-auto">
                        Copyright © <b> Mandiri Group </b> 2022
                    </div>				
                </div>
			</footer>
		</div>		
	...
	<script>
        $(document).ready(function() {
            $('#list').DataTable({
                ...
                "language": {
                    "lengthMenu": "Tampilkan _MENU_  Daftar User",
                    "zeroRecords": "Maaf, tidak dapat menemukan apapun",
                    "info": "Menampilkan halaman _PAGE_ dari _PAGES_ halaman",
                    "infoEmpty": "Tidak ada User yang dapat ditampilkan",
                    "infoFiltered": "(dari _MAX_ Daftar User)",
                    "search": "Cari :",
                    "paginate": {
                        "first": "Pertama",
                        "last": "Terakhir",
